  ...
  return (
    ...
    >
      <SentryRoutes>
        ...
        <Route path={`/${FarmingRoutes.VersionOne}/${NOT_FOUND_LETTER_ROUTE_NAME}`} element={<PageNotFoundPage />} />
        ...
        <Route path={`/:version/${NOT_FOUND_LETTER_ROUTE_NAME}`} element={<PageNotFoundPage />} />
