...
import { FarmingItemModel, FarmingItemResponseModel } from '../models';
...
export class FarmingItemStore {
  ...
  get farmingItem(): Nullable<
    FarmingItemModel & { depositBalance: Nullable<BigNumber>; earnBalance: Nullable<BigNumber> }
  > {
