...
export const EnTermsOfService: FC = () => (
  <>
    <h1 className={styles.mb24} data-cy="termsOfService">
      Terms of Service
    </h1>
    ...
    <h4 className={styles.mt40}>1. Modification of this Agreement</h4>
    <br />
    <p className={styles.big}>
      <span className={styles.list}>1.1.</span> We reserve the right, in our sole discretion, to modify this Agreement
      at any time. If we make any modifications, we will notify you by updating the date at the top of the Agreement and
    ...
    <p className={cx(styles.big, styles.mt40)}>
      ...
      continued use of the Interface will serve as confirmation of your acceptance of those modifications. If you do not
      agree with any modifications to this Agreement, you must immediately stop accessing and using the Interface.
    </p>
    ...
    <h4 className={styles.mt40}>3. Proprietary Rights</h4>
    <br />
    <p className={styles.big}>
      <span className={styles.list}>3.1.</span> We own all intellectual property and other rights in the Interface and
      its contents, including (but not limited to) text, images, trademarks, service marks, copyrights, and designs.
      Unless expressly authorized by us, you may not copy, modify, adapt, rent, license, sell, publish, distribute, or
      otherwise permit any third party to access or use the Interface or any of its contents.
    </p>
    <br />
    <p className={styles.big}>
      <span className={styles.list}>3.2.</span> Unlike the Interface, the AMM Protocol is composed entirely of
      open-source software running on the public Tezos blockchain and is distributed under the MIT license. Basically,
      you can do whatever you want as long as you include the original copyright and license notice in any copy of the
      software/source.
    </p>
    <h4 className={styles.mt40}>4. Prohibited Activity</h4>
    <br />
    <div className={styles.big}>
    ...
    <h4 className={styles.mt40}>5. No Financial Advice</h4>
    <br />
    <p className={styles.big}>
    ...
    <h4 className={styles.mt40}>6. No Warranties</h4>
    <br />
    <p className={styles.big}>
      <span className={styles.list}>6.1.</span> The Interface is provided on an “AS IS” and “AS AVAILABLE” basis. To the
    ...
    <p className={cx(styles.big, styles.mt40)}>
      <span className={styles.list}>6.2.</span> We do not represent and warrant that access to the Interface will be
    ...
    <h4 className={styles.mt40}>7. Assumption of Risk</h4>
    <br />
    <p className={styles.big}>
      <span className={styles.list}>7.1.</span> By accessing and using the Interface, you represent and warrant that you
      understand
    </p>
    <br />
    ...
    <br />
    <p className={styles.big}>
      <span className={styles.list}>7.2.</span> You further represent and warrant that you have a working knowledge of
      the usage and intricacies of blockchain-based digital assets, including, without limitation, FA1.2 and FA2 token
      standards available on the Tezos blockchain.
    </p>
    <br />
    <p className={styles.big}>
      <span className={styles.list}>7.3.</span> You further understand that the markets for these blockchain-based
      digital assets are highly volatile due to factors that include, but are not limited to, adoption, speculation,
      technology, security, and regulation.
    </p>
    <br />
    <p className={styles.big}>
      <span className={styles.list}>7.4.</span> You acknowledge that the cost and speed of transacting with
      blockchain-based systems, such as Tezos, are variable and may increase or decrease, respectively, drastically at
      any time.
    </p>
    <br />
    <p className={styles.big}>
      <span className={styles.list}>7.5.</span> You hereby acknowledge and agree that we are not responsible for any of
      these variables or risks associated with the Protocol and cannot be held liable for any resulting losses that you
    ...
    <h4 className={styles.mt40}>8. Third-Party Resources and Promotions</h4>
    <br />
    <p className={styles.big}>
      <span className={styles.list}>8.1.</span> The Interface may contain references or links to third-party resources,
    ...
    <p className={cx(styles.big, styles.mt40)}>
      <span className={styles.list}>8.2.</span> We do not endorse or assume any responsibility for any such resources or
    ...
    <h4 className={styles.mt40}>9. Limitation of Liability</h4>
    <br />
    <div className={styles.big}>
    ...
    <h4 className={styles.mt40}>10. Release of Claims</h4>
    <br />
    <p className={styles.big}>
    ...
    <h4 className={styles.mt40}>11. Limitation of Liability</h4>
    <br />
    <div className={styles.big}>
    ...
    <h4 className={styles.mt40}>12. Class Action and Jury Trial Waiver</h4>
    <br />
    <p className={styles.big}>
    ...
    <h4 className={styles.mt40}>13. Dispute Resolution</h4>
    <br />
    <p className={styles.big}>
    ...
    <h4 className={styles.mt40}>14. Governing Law</h4>
    <br />
    <p className={styles.big}>
    ...
    <h4 className={styles.mt40}>15. Entire Agreement</h4>
    <br />
    <p className={styles.big}>
