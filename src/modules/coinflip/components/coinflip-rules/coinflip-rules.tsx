...
export const CoinflipRules: FC = observer(() => {
  const { networkFee, maxBetPercent, dataExists } = useCoinflipRulesViewModel();
      ...
      <div>
        ...
        <ul className={cx(styles.list, styles.ul)}>
          <li className={styles.li}>
            ...
            team fall into this pool. Note that you can not make a bid that is greater than ${maxBetPercent}% of the rewards pool for obvious reasons.`}
          </li>
          <li className={styles.li}>
