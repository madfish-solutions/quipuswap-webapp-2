  ...
  return (
    <>
      ...
      <div className={s.amountsWrapper}>
        ...
        <StateCurrencyAmount amount={maxInvestedOrReceivedA.toFixed()} currency={getWhitelistedTokenSymbol(tokenA)} />
      </div>
      <div className={s.amountsWrapper}>
        <span className={s.receiveLabel}>Max {investedOrReceivedText} B:</span>
        <StateCurrencyAmount amount={maxInvestedOrReceivedB.toFixed()} currency={getWhitelistedTokenSymbol(tokenB)} />
      </div>
    </>
  );
};
