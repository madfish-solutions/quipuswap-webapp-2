...
//#region defult stableswap fee
export const CONTRACT_DECIMALS_PRECISION_POWER = 1e18;
const DEFAULT_STABLESWAP_INTERFACE_FEE = 0.005;
const DEFAULT_STABLESWAP_STAKERS_FEE = 0.03;

export const DEFAULT_STABLESWAP_INTERFACE_FEE_WITH_PRECISION = new BigNumber(
  DEFAULT_STABLESWAP_INTERFACE_FEE
).multipliedBy(STABLESWAP_PRECISION_FEE);
export const DEFAULT_STABLESWAP_STAKERS_FEE_WITH_PRECISION = new BigNumber(DEFAULT_STABLESWAP_STAKERS_FEE).multipliedBy(
