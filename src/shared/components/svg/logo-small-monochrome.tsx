...
export const LogoSmallMonochrome: FC<IconProps> = ({ className }) => (
  <svg width={24} height={24} fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="m20.008 19.448-3.862-3.864a1.575 1.575 0 0 1 0-2.22 1.57 1.57 0 0 1 2.22 0l3.862 3.865a1.568 1.568 0 0 1-.33 2.472 1.576 1.576 0 0 1-1.89-.253Zm-4.504-3.392 3.949 3.947a1.568 1.568 0 0 1-.312 2.463 1.574 1.574 0 0 1-1.909-.244l-3.861-3.864a1.568 1.568 0 0 1 .657-2.614 1.565 1.565 0 0 1 1.476.312Z"
    />
  </svg>
);
