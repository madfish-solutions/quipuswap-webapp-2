...
export const FarmIcon: React.FC<IconProps> = ({
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path d="M3 16.9998V16.9998C2.42439 16.9998 1.93455 16.5805 1.84568 16.0118L0.890279 9.89772C0.806726 9.36302 1.07863 8.83568 1.56269 8.59366V8.59366C1.98392 8.38304 2.25 7.95251 2.25 7.48156V4.5C2.25 3.67157 2.92157 3 3.75 3H9.22183C9.95837 3 10.5859 3.53476 10.7028 4.26198L12.75 16.9998H10.5" stroke={`url(#FarmIcon-${id}paint0_linear)`} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M1.5 9H11.25" stroke={`url(#FarmIcon-${id}paint1_linear)`} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M20 17H20.6109C21.3947 17 22.0464 16.3965 22.1065 15.6151L22.3912 11.9144C22.4522 11.1208 21.8828 10.4177 21.0939 10.3125L11.25 9L12.75 17H16" stroke={`url(#FarmIcon-${id}paint2_linear)`} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M6.75 19.5C8.82107 19.5 10.5 17.8211 10.5 15.75C10.5 13.6789 8.82107 12 6.75 12C4.67893 12 3 13.6789 3 15.75C3 17.8211 4.67893 19.5 6.75 19.5Z" stroke={`url(#FarmIcon-${id}paint3_linear)`} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
