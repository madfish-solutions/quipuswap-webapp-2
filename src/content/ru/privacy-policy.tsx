...
export const RuPrivacy: React.FC = () => (
  <>
    ...
    <br />
    <p className={s.big}>
      By using the Services, you accept the terms of this <span className={s.list}>Политика приватности</span> and our{' '}
      <span className={s.list}>Terms of Service</span>
      {', '}
      and consent to our collection, use, disclosure, and retention of your information as described in this Policy. If
      you have not done so already, please also review our <span className={s.list}>Terms of Service</span>.
    </p>
    <br />
    <p className={s.big}>
      IF YOU ARE UNWILLING TO AGREE TO THIS PRIVACY POLICY, OR YOU DO NOT HAVE THE RIGHT, POWER, AND AUTHORITY TO ACT ON
      BEHALF OF AND BIND THE BUSINESS, ORGANIZATION, OR OTHER ENTITY YOU REPRESENT, DO NOT ACCESS OR OTHERWISE USE THE
      INTERFACE.
    </p>
    <br />
    <p className={s.big}>
      “Company”, “we”, “our”, or “us”) collects, uses, shares, and stores personal information of users of its website:{' '}
      <span className={s.list}>Madfish Solutions</span> decides “why” and “how” your Personal Data is processed in
      connection with the Interface. If you have additional questions or require more information about this Privacy
    ...
    <br />
    <p className={s.big}>
      This Privacy Policy applies only to the Interface activities and is valid for participants which are users of the
      Interface with regards to the Personal Data that they shared and/or collect within Quipuswap Interface. This
      Privacy Policy is not applicable to any Personal Data collected offline or via channels other than the Interface.
      Please read this Privacy Policy carefully to understand our policies and practices regarding your data and how it
      will be treated by the Interface.
    </p>
    <h4 className={s.mt40}>1. Modification of this Policy</h4>
    <br />
    <p className={s.big}>
      <span className={s.list}>1.1.</span> We reserve the right, in our sole discretion, to modify this Policy from time
      to time. If we make any modifications, we will notify you by updating the date at the top of the Agreement and by
      maintaining a current version of the Policy at{' '}
    ...
    <p className={cx(s.big, s.mt40)}>
      ...
      with any modifications to this Policy, you must immediately stop accessing and using the Interface.
    </p>
    ...
    <div className={s.big}>
      ...
      <ol className={s.ol}>
        ...
        <li>
          Data related to usage, performance, site security, traffic patterns, location information, browser, and device
          information only when you are using our services at our Interface.
        </li>
    ...
    <p className={s.big}>
      ...
      information about how you use our Interface (we refer to this information as “Log Data“) by using Google Analytics
      or Product analytical tools. Log Data may include:
      <br />
      <br />
      <ol className={s.ol}>
        <li>the information such as a user’s, device, and browser type, operating system;</li>
        <li>
          the pages or features of our Interface to which a user browsed and the time spent on those pages or features;
        </li>
    ...
    <p className={s.big}>
      ...
      engage third parties to analyze) this information to improve and enhance the Service by expanding its features and
      functionality and tailoring it to our users’ needs and preferences.
    </p>
    <br />
    <p className={s.big}>
      <span className={s.list}>4.3.</span> We may use cookies, local storage, or similar technologies to analyze trends,
      administer the Interface, track users’ movements around the Interface, and gather demographic information about
      our user base as a whole. Users can control the use of cookies and local storage at the individual browser level.
    </p>
    <br />
    <p className={s.big}>
      <span className={s.list}>4.4.</span> We also may use Google Analytics (and similar services) to help us offer you
    ...
    <p className={s.big}>
      ...
      use your personal information to operate, maintain, and improve our Services. We may also use your information to
      respond to your comments and questions regarding the Services and to provide you and other users with general
      customer service.
    </p>
    <br />
    <p className={s.big}>
    ...
    <br />
    <p className={s.big}>
      <span className={s.list}>7.1.</span> We retain the information we collect as long as it is necessary and relevant
      to fulfill the purposes outlined in this privacy policy. In addition, we retain personal information to prevent
      fraud, resolve disputes, troubleshoot problems, assist with any investigation, enforce our Terms of Service, and
    ...
    <br />
    <p className={s.big}>
      <span className={s.list}>7.3.</span> We employ standard security measures designed to protect the security of all
      information submitted through the Services. However, the security of information transmitted through the internet
      can never be guaranteed. We are not responsible for any interception or interruption of any communications through
    ...
    <p className={s.big}>
      ...
      password, biometrics, user ID, or other forms of authentication involved in obtaining access to password-protected
      or secure areas of any of our digital services.
    </p>
    <br />
    <p className={s.big}>
      <span className={s.list}>7.5.</span> In order to protect you and your data, we may suspend your use of any of the
      Services, without notice, pending an investigation, if any breach of security is suspected.
    </p>
    ...
    <p className={s.big}>
      ...
      cookies. If you disable or refuse cookies, please note that some parts of the Interface may become inaccessible or
