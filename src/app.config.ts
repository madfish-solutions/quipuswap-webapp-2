...
export const APOLLO_CLIENT_ENDPOINT = process.env.REACT_APP_PUBLIC_APOLLO_CLIENT_ENDPOINT;
...
export const FEE_RATE = process.env.REACT_APP_PUBLIC_FEE!;
export const APP_NAME = process.env.REACT_APP_PUBLIC_APP_NAME!;
export const BASE_URL = process.env.REACT_APP_PUBLIC_BASE_URL!;

export const BAKERS_API = process.env.REACT_APP_PUBLIC_BAKERS_API_URL!;
export const MAINNET_TOKENS = process.env.REACT_APP_PUBLIC_MAINNET_TOKENS!;
export const TESTNET_TOKENS = process.env.REACT_APP_PUBLIC_TESTNET_TOKENS!;
...
export const READ_ONLY_SIGNER_PK = process.env.REACT_APP_PUBLIC_READ_ONLY_SIGNER_PK!;
export const READ_ONLY_SIGNER_PK_HASH = process.env.REACT_APP_PUBLIC_READ_ONLY_SIGNER_PK_HASH!;
export const MAINNET_LAMBDA_VIEW_CONTRACT = process.env.REACT_APP_PUBLIC_MAINNET_LAMBDA_VIEW_CONTRACT!;
export const HANGZHOUNET_LAMBDA_VIEW_CONTRACT = process.env.REACT_APP_PUBLIC_HANGZHOUNET_LAMBDA_VIEW_CONTRACT!;
...
export const METADATA_API_MAINNET = process.env.REACT_APP_PUBLIC_METADATA_API_MAINNET!; // 'ex https://<host>:<port>/metadata'
export const METADATA_API_TESTNET = process.env.REACT_APP_PUBLIC_METADATA_API_TESTNET!;
export const POOLS_LIST_API = process.env.REACT_APP_PUBLIC_POOLS_LIST_API!;
// NETWORKS
export const MAINNET_RPC_URL = process.env.REACT_APP_PUBLIC_MAINNET_RPC_URL!;
export const HANGZHOUNET_RPC_URL = process.env.REACT_APP_PUBLIC_HANGZHOUNET_RPC_URL!;
