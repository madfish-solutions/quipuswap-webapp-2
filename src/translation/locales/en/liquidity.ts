export const liquidity = {
  ...
  APR: 'APR (7d)',
  aprUpTo: 'APR up to',
  aprTooltip: 'Annual percentage rate for liquidity providers of the selected pool (according to weekly data).',
  maxApr: 'Max APR',
  ...
  weeklyVolumeTooltip: 'Total value of exchanged assets between buyers and sellers during 7 days.',
