...
describe('Form exists', () => {
  it.skip('Should_DisplayFarmingDetails_When_OpenedFarmingPage', () => {
    ...
    cy.get('.slick-current > :nth-child(1) > .top-stats_container__31ipz > .top-stats_title__38Gvl').should(
      'contain',
      'Total Value  Locked'
    );
    // Check if 'Earn extra income' text is ok
    cy.get('.pending-rewards_amount__3jDO2').should('contain', 'Earn extra income with QuipuSwap');
  });
});
