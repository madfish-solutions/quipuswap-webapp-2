...
describe('DEX Dashboard section', () => {
    ...
    cy.get('.Card-module_content__3gIG2 > :nth-child(1) > .DashboardCard_header__1QjFP > .tooltip_wrapper__2x_KN > .tooltip_info__3hAfB')
        .should('be.visible')
          
    cy.get('.Card-module_content__3gIG2 > :nth-child(2) > .DashboardCard_header__1QjFP > .tooltip_wrapper__2x_KN > .tooltip_info__3hAfB')
        .should('be.visible')

    cy.get('.Card-module_content__3gIG2 > :nth-child(3) > .DashboardCard_header__1QjFP > .tooltip_wrapper__2x_KN > .tooltip_info__3hAfB')
        .should('be.visible')

    cy.get('.Card-module_content__3gIG2 > :nth-child(4) > .DashboardCard_header__1QjFP > .tooltip_wrapper__2x_KN > .tooltip_info__3hAfB')
        .should('be.visible')
})
